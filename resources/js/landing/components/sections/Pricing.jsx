        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          {PRICING.plans.map((plan, index) => (
            <motion.div
              ...
              className={`relative rounded-2xl border p-5 backdrop-blur sm:rounded-3xl sm:p-8 ${plan.highlighted
            ...
            >
              {plan.highlighted && (
                <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-cyan-400/40 bg-cyan-400/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-cyan-200 sm:absolute sm:right-6 sm:top-6 sm:mb-0 sm:text-xs sm:tracking-[0.3em]">
